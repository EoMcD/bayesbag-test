...
def main():
    ...
    def fit_pymc_model(synthetic):
        ...
        with pm.Model() as model:
            ...
            mu = pm.Uniform("mu", lower=-5, upper=35) # uniform mu informed by estimated effects
    ...
    plt.savefig(os.path.join(output_dir, "sat_means_uniforms.pdf"), bbox_inches="tight")
    plt.close()
    ...
    plt.savefig(os.path.join(output_dir, "sat_std_uniforms.pdf"), bbox_inches="tight")
    plt.close()
    ...
    plt.savefig(os.path.join(output_dir, "sat_comparison_uniforms.pdf"), bbox_inches="tight")
    plt.close()
