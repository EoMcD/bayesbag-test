...
def main():
    ...
    trace_bb_clean = bayesbag_gamma(X,B=100,draws=2000,tune=1000,chains=4)
    ...
    trace_bb_contam = bayesbag_gamma(Xc,B=100,draws=2000,tune=1000,chains=4)
    trace_bag_contam = trace_bb_contam["trace"]

    # NORMAL
    trace_std_norm = fit_normal(X, draws=2000, tune=1000, chains=4, seed=42)
    norm_bag = bayesbag_normal(X, B=100, draws=2000, tune=1000, chains=4, seed=42, m_frac=1.0)
    ...
    meta = dict(
        ...
        draws=2000, tune=1000, chains=4, B=100, m_frac=1.0
    )
